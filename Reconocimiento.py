...
def draw_output(frame, coordinates_left_eye, coordinates_right_eye, blink_counter):
    ...
    cv2.putText(output, "Num. Blinks:", (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)  # Changed color to red
    cv2.putText(output, "{}".format(blink_counter), (220, 35), cv2.FONT_HERSHEY_SIMPLEX, 0.9, (0, 0, 255), 2)  # Changed color to red
    return output
        ...
        while True:
            ...
            if results.multi_face_landmarks is not None:
                for face_landmarks in results.multi_face_landmarks:
                    ...
                    frame = draw_output(frame, coordinates_left_eye, coordinates_right_eye, blink_counter)
                    pts_ear.append(ear)

                    if i > 70:
                        line1 = plot_ear(pts_ear, line1)
                    i += 1
